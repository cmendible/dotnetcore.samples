...
.PARAMETER Clean
Removes the image debug.on.docker and kills all containers based on that image.
...
Build a Docker image named debug.on.docker
#>
...
$imageName="debug.on.docker"
$projectName="debugondocker"
$serviceName="debug.on.docker"
